...
export const metadata: Metadata = {
  title: "★★★★★ Generator Repairs Johannesburg 2025 | #1 Expert 24-Hour Service",
  description:
    "★★★★★ #1 professional generator repairs in Johannesburg. Diesel & petrol generators. 24-hour emergency service. Certified technicians. All suburbs. Call 069 382 4908 now!",
  keywords: [
    "generator repairs johannesburg",
    "diesel generator repairs johannesburg",
    "petrol generator repairs johannesburg",
    "generator servicing johannesburg",
    "emergency generator repairs johannesburg",
    "24 hour generator repairs johannesburg",
    "generator maintenance johannesburg",
    "generator repair near me johannesburg",
  ],
  openGraph: {
    title: "Generator Repairs Johannesburg | Expert 24-Hour Service",
    description:
      "Professional generator repairs in Johannesburg. Diesel & petrol generators. 24-hour emergency service. Certified technicians serving all suburbs.",
  ...
  alternates: {
    canonical: "https://generatorrepairservices.co.za/generator-repairs-johannesburg",
  },
}
